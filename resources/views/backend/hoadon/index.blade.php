                      ...
                      <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                {{-- @dd($id_phong) --}}
                                <td>
                                  <a href="{{route('phongtro.hoadon.detailhoadon',['id' => $nhatro->id , 'id_phong' => $id_phong , 'id_hoadon' => $item->id])}}" class="btn btn-success" style="color: white;">Xem chi tiết</a>
                                  <a href="{{route('hoadontro.suahoadon.get',['id' => $nhatro->id , 'id_phong' => $id_phong , 'id_hoadon' => $item->id])}}" class="btn btn-warning ml-3" style="color: white;">Chỉnh sửa</a>
