...
@section('title', 'Chỉnh sửa chi phí dịch vụ')
@section('main')
                                    ...
                                    <form method="POST" class="forms-sample"
                                        ...
                                        <div class="form-group row">
                                            <label for="tien_dien_int" class="col-sm-3 col-form-label">Tiền điện / 1 kwh
                                                :</label>
                                            <div class="col-sm-9">
                                                <input value="{{$chiphi->tien_dien_int}}" name="tien_dien_int" type="number" class="form-control"
                                        ...
                                        <div class="form-group row">
                                            <label for="tien_nuoc_int" class="col-sm-3 col-form-label">Tiền nước / m3
                                                :</label>
                                            <div class="col-sm-9">
                                                <input value="{{$chiphi->tien_nuoc_int}}" name="tien_nuoc_int" type="number" class="form-control"
                                        ...
                                        <div class="form-group row">
                                            <label for="tien_mang_int" class="col-sm-3 col-form-label">Tiền mạng / 1 Tháng
                                                :</label>
                                            <div class="col-sm-9">
                                                <input value="{{$chiphi->tien_mang_int}}" name="tien_mang_int" type="number" class="form-control"
                                        ...
                                        <div class="form-group row">
                                            <label for="tien_binh_nuoc" class="col-sm-3 col-form-label">Tiền bình nước
                                                :</label>
                                            <div class="col-sm-9">
                                                <input value="{{$chiphi->tien_binh_nuoc}}" name="tien_binh_nuoc" type="number" class="form-control"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input name="ten_chu_tk" type="text" class="form-control"
                                                    id="ten_chu_tk" placeholder="Nhập Tiền bình nước" value="{{$chiphi->ten_chu_tk}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input name="chi_nhanh" type="text" class="form-control"
                                                    id="chi_nhanh" placeholder="Nhập Tiền bình nước" value="{{$chiphi->chi_nhanh}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input name="noi_dung_ck" type="text" class="form-control"
                                                    id="noi_dung_ck" placeholder="Nhập Tiền bình nước" value="{{$chiphi->noi_dung_ck}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            <img src="/uploads/img/{{$chiphi->anh_qr_code}}" alt="QR Code Thanh Toán">
