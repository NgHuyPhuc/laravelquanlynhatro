                            ...
                            <div class="card-body">
                                ...
                                <div class="template-demo">
                                    <a href="{{route('phongtro.nguoithue.themnguoi',['id' => $nhatro->id, 'id_phong' => $phongtro->id])}}" class="btn btn-info">Thêm mới người
                                        thuê phòng</a>
                                        @if ($check == 0)
                                            <a href="{{route('phongtro.hoadon.sodiennuoc1',['id' => $nhatro->id, 'id_phong' => $phongtro->id])}}" class="btn btn-success">Thêm mới số tiền điện nước hiện tại</a>
                                        @else
                                            <a href="{{route('phong.nguoithue.dangthue',['id' => $id, 'id_phong' => $phongtro->id])}}" class="btn btn-info">Xem thông tin người thuê phòng</a>
                                        ...
                                        @endif
                                    <a href="{{route('nhatro.phong.hoadon.show.all.info',['id' => $nhatro->id, 'id_phong' => $phongtro->id])}}" class="btn btn-success">Xem hóa đơn tiền phòng</a>
